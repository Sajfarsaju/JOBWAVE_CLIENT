    ...
    <div className="bg-white mt-1">
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <div className="min-h-full flex flex-col md:flex-row">
          <div className="md:w-1/2">
            <div className="text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:pt-24 hover:scale-105 duration-500">
                Find your Dream Job
              </h1>
              <p className="mt-6 text-lg leading-8 text-gray-600  hover:scale-105 duration-1000">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <Link
                  to='/jobs'
                  className="hover:scale-105 duration-1000  flex-none rounded-md bg-blue-500 px-3.5 py-2.5 text-sm font-semibold dark:text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
                >
                  Get started
                </Link>
                <a href="#" className="text-sm font-semibold hover:scale-105 duration-1000 leading-6 text-gray-900 hover:text-sky-600">Learn more <span aria-hidden="true">→</span></a>
              </div>
            </div>
          </div>
