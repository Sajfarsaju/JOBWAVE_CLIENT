                ...
                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                  ...
                  <div className="hidden sm:ml-6 sm:block">
                    <div className="flex space-x-4">
                      ...
                      <Link
                        to="/"
                        className={`rounded-md px-3 py-2 text-sm font-medium hover:text-emerald-700
                    ${pathname === '/' ? 'dark:text-emerald-500 ' : 'text-gray-900 '
                     ...
                     ${pathname === '/jobs' ? 'dark:text-emerald-500 ' : 'text-gray-900 '
                      ...
                      <Link
                        to={'/support'}
                        className="rounded-md px-3 py-2 text-sm font-medium hover:text-emerald-700 text-gray-900 "
                      >Support
                      </Link>
                    ...
                    >
                      {token ? (
                        <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                          <Menu.Item>
                            <Link to="/profile" className={`hover:bg-gray-200 flex items-center px-4 py-2 text-sm text-gray-700 ${pathname === '/profile' ? 'bg-gray-200' : ''}`}>
                          ...
                          <Menu.Item>
                            <a href="#" className="hover:bg-gray-200 flex items-center px-4 py-2 text-sm text-gray-700">
                              <svg className="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <Menu.Item>
                            <a onClick={() => setIsAlertOpen(true)} href="#" className="hover:bg-gray-200 flex items-center px-4 py-2 text-sm text-gray-700">
                              <svg className="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {isAlertOpen && (
        ...
        >
          <div className="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform dark:bg-white rounded-lg shadow-xl shadow-gray-500 rtl:text-right sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
              <div>
              ...
              <div className="mt-5 sm:flex sm:items-center sm:justify-center">
                ...
                <div className="sm:flex sm:items-center">
                  <button
                    ...
                    className="w-full px-4 py-2 mt-2 text-sm font-medium tracking-wide text-gray-700 capitalize transition-colors duration-300 transform border border-gray-200 rounded-md sm:mt-0 sm:w-auto sm:mx-2 dark:text-gray-200 dark:border-gray-700 dark:bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40"
                  >
                    Cancel
                  </button>
