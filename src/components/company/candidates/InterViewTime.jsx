...
export default function InterViewTime() {
  ...
  //   const openShortlistModal = (userId , applicationId) => {
  //     console.log('idddddd;' , applicationId)
  //     setUserId(userId)
          ...
          <>
            <div className="h-auto flex flex-col items-center justify-center mt-32">
              ...
              <div className="flex flex-wrap w-11/12 ">
                {/* Card 1 */}
                {shortlistDetail.map((candidate, index) => (
                    ...
                    <div key={candidate._id} className="w-full sm:w-1/2 p-5">
                      <div className="bg-teal-50 p-6 rounded-lg shadow-md shadow-slate-400">
                        ...
                        <div className="mt-4 flex items-center">
                          ...
                          <p
                            // onClick={()=>openShortlistModal(candidate?.applicant?._id , candidate._id)}
