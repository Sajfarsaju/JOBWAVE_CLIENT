...
function Section() {
  ...
  const handlePayment = async (planAmt , planType) => {
    ...
    try {
      const response = await Axios_Instance.post('/company/companyPlan', { planAmt, id , planType},).then((res) => {
  ...
  return (
    ...
    */}
      <section className="bg-gray-100 lg:py-12 lg:flex lg:justify-center">
        <div className="overflow-hidden hover:scale-105 duration-1000 bg-white shadow-lg shadow-gray-400 mt-16 lg:mx-8 lg:flex lg:max-w-6xl lg:w-full lg:shadow-md lg:rounded-xl">
                          ...
                          <div className="flex flex-col mt-4 md:flex-row md:justify-between">
                            ...
                            <div className="max-w-sm mx-auto border rounded-lg dark:border-gray-800">
                              <div className="p-6">
                                ...
                                <h3 className="mt-4 text-2xl font-semibold text-gray-700 sm:text-3xl dark:text-emerald-600">
                                  ₹5000.00 <span className="text-base font-medium">/Lifetime</span>
                                </h3>
                                ...
                                <button
                                  onClick={() => handlePayment(5000 , 'Lifetime')}
