           ...
           <footer className="font-dm-sans font-normal bg-slate-100 text-white py-8">
            <div className="container mx-auto px-4 sm:px-4 md:px-4 lg:px-8 xl:px-8 flex flex-col sm:flex-row justify-center">
                ...
                <div className="w-full sm:w-1/3 flex flex-col items-start p-4">
                    ...
                    <Link to={'#'} className="flex justify-center sm:justify-start lg:justify-start xl:justify-start text-center text-white px-8 sm:px-10 py-3 rounded mx-auto lg:mx-0 mt-12 md:mt-auto lg:mt-auto xl:mt-auto mb-6 " style={{ backgroundColor: 'rgba(0, 13, 255, 1)' }}>
                        Find Talent
                    </Link>
                </div>
            </div>
