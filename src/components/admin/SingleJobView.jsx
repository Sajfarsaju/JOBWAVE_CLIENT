    ...
    return (
        <>
            {isOpenJobView && (
                ...
                <Transition.Root show={isOpenJobView} as={Fragment}>
                    <Dialog as="div" className="fixed inset-0 z-10 overflow-y-auto" onClose={setIsOpenJobView}>
